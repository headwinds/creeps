...
return (new CustomEvent(event_name,(function (){var obj32384 = {"detail":data};
return obj32384;
})()));
} else {
...
var f = (function (){var pred__32391 = cljs.core._EQ_;
var expr__32392 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32391.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32392))){
return ((function (pred__32391,expr__32392){
return (function (p1__32385_SHARP_){
return console.warn(p1__32385_SHARP_);
});
;})(pred__32391,expr__32392))
} else {
if(cljs.core.truth_(pred__32391.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32392))){
return ((function (pred__32391,expr__32392){
return (function (p1__32386_SHARP_){
return console.debug(p1__32386_SHARP_);
});
;})(pred__32391,expr__32392))
} else {
if(cljs.core.truth_(pred__32391.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32392))){
return ((function (pred__32391,expr__32392){
return (function (p1__32387_SHARP_){
return console.error(p1__32387_SHARP_);
});
;})(pred__32391,expr__32392))
} else {
return ((function (pred__32391,expr__32392){
return (function (p1__32388_SHARP_){
return console.log(p1__32388_SHARP_);
});
;})(pred__32391,expr__32392))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32395){
...
var eval_fn = cljs.core.get.call(null,map__32396__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32398_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__32400,(0),null);
...
}catch (e32405){if((e32405 instanceof Error)){
var e = e32405;
return not_found;
} else {
throw e32405;
...
//# sourceMappingURL=utils.js.map?rel=1536537367800
