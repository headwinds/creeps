...
var vec__26108_26111 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_26112 = cljs.core.nth.call(null,vec__26108_26111,(0),null);
var only_after_26113 = cljs.core.nth.call(null,vec__26108_26111,(1),null);
var db_changed_QMARK__26114 = ((!((only_before_26112 == null))) || (!((only_after_26113 == null))));
if(db_changed_QMARK__26114){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_26112);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_26113);
...
var map__26115 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__26115__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__26115__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__26117 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__26117__$1;
var event = cljs.core.get.call(null,map__26117__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
args__4534__auto__.push((arguments[i__4532__auto___26121]));
...
/** @this {Function} */
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq26119){
var self__4519__auto__ = this;
return self__4519__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26119));
});
...
var args__4534__auto__ = [];
var len__4531__auto___26128 = arguments.length;
var i__4532__auto___26129 = (0);
while(true){
if((i__4532__auto___26129 < len__4531__auto___26128)){
args__4534__auto__.push((arguments[i__4532__auto___26129]));

var G__26130 = (i__4532__auto___26129 + (1));
i__4532__auto___26129 = G__26130;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__26123_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__26124_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__26124_SHARP_);
...
/** @this {Function} */
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq26125){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26126,G__26127,seq26125__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1536537358312
