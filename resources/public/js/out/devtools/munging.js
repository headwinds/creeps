...
var o27433 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27433["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27434 = temp__5455__auto____$1;
return (o27434["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27253__auto__ = f;
return (o__27253__auto__["toString"]).call(o__27253__auto__);
} else {
return "";
}
}catch (e27435){var _ = e27435;
return "";
}});
...
try{var o__27253__auto___27437 = t;
(o__27253__auto___27437["cljs$lang$ctorPrWriter"]).call(o__27253__auto___27437,t,writer);
}catch (e27436){var __27438 = e27436;
}
...
var char_code = (function (){var o__27253__auto__ = (new String(char$));
return (o__27253__auto__["charCodeAt"]).call(o__27253__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27253__auto__ = String;
return (o__27253__auto__["fromCharCode"]).call(o__27253__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27439 = num_code;
switch (G__27439) {
case (1):
return (185);
...
var o__27253__auto__ = String;
return (o__27253__auto__["fromCharCode"]).call(o__27253__auto__,superscript_code);
});
/**
...
}catch (e27441){var _e__27260__auto__ = e27441;
return false;
}})())){
...
var vec__27442 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__27442,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o27445 = temp__5455__auto__;
var temp__5455__auto____$1 = (o27445["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o27446 = temp__5455__auto____$1;
return (o27446["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27449){
var vec__27450 = p__27449;
var ns_detector = cljs.core.nth.call(null,vec__27450,(0),null);
...
var G__27456 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__27457 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__27456;
remaining_tokens = G__27457;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27447){
var G__27448 = cljs.core.first.call(null,seq27447);
var seq27447__$1 = cljs.core.next.call(null,seq27447);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27448,seq27447__$1);
});
...
var vec__27461 = cljs.core.split_with.call(null,(function (p1__27460_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27460_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__27461,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__27461,(1),null);
...
var vec__27464 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__27464,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__27464,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__27467 = cljs.core.rest.call(null,remaining_tokens);
var G__27468 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__27467;
name_tokens = G__27468;
continue;
} else {
...
var vec__27471 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__27471,(0),null);
var arity = cljs.core.nth.call(null,vec__27471,(1),null);
var vec__27474 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__27474,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__27474,(1),null);
var vec__27477 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__27477,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__27477,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__27477,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__27477,(3),null);
...
var vec__27483 = result;
var munged_ns = cljs.core.nth.call(null,vec__27483,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__27483,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__27483,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__27483,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__27483,(4),null);
var arity = cljs.core.nth.call(null,vec__27483,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__27487 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__27487,(0),null);
var args = cljs.core.nth.call(null,vec__27487,(1),null);
var vec__27490 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__27490,(0),null);
var name = cljs.core.nth.call(null,vec__27490,(1),null);
...
var G__27493 = (arity + (1));
var G__27494 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27495){
var vec__27496 = p__27495;
var arity = cljs.core.nth.call(null,vec__27496,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__27496,(1),null);
...
return cljs.core.get.call(null,arities,p1__27499_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__27500_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27503){
var vec__27504 = p__27503;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__27504,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27501){
var G__27502 = cljs.core.first.call(null,seq27501);
var seq27501__$1 = cljs.core.next.call(null,seq27501);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27502,seq27501__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__27512__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__27512__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__27512__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__27512__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27513 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__27513,(0),null);
var fn_name = cljs.core.nth.call(null,vec__27513,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__27513,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__27513,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__27513,(4),null);
var arity = cljs.core.nth.call(null,vec__27513,(5),null);
...
var o__27253__auto__ = f;
return (o__27253__auto__["getBasis"]).call(o__27253__auto__);
});
/**
...
}catch (e27517){var _e__27260__auto__ = e27517;
...
var G__27518 = (obj[cljs.core.first.call(null,path)]);
var G__27519 = cljs.core.rest.call(null,path);
obj = G__27518;
path = G__27519;
continue;
} else {
...
return (function (accum,p__27520){
var vec__27521 = p__27520;
var bit = cljs.core.nth.call(null,vec__27521,(0),null);
var protocol = cljs.core.nth.call(null,vec__27521,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27524){
var vec__27525 = p__27524;
var ns = cljs.core.nth.call(null,vec__27525,(0),null);
var name = cljs.core.nth.call(null,vec__27525,(1),null);
var selector = cljs.core.nth.call(null,vec__27525,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__27530,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__27530,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__27530,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__27528_SHARP_){
return (obj[cljs.core.first.call(null,p1__27528_SHARP_)]);
});})(name,sorted_matches,vec__27530,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1536537359957
