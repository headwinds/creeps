...
var len__4531__auto___28052 = arguments.length;
var i__4532__auto___28053 = (0);
while(true){
if((i__4532__auto___28053 < len__4531__auto___28052)){
args__4534__auto__.push((arguments[i__4532__auto___28053]));

var G__28054 = (i__4532__auto___28053 + (1));
i__4532__auto___28053 = G__28054;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28049){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28050,G__28051,seq28049__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28055_SHARP_){
return !((cljs.core.meta.call(null,p1__28055_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__28056__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28060){var _e__27260__auto__ = e28060;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e28062){var _e__27260__auto__ = e28062;
return false;
}}
})())){
...
var _STAR_current_state_STAR_28064 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__28065 = opts;
...
var markup_db = cljs.core.get.call(null,map__28065__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_28064;
}});
...
;
var temp__5455__auto___28069 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___28069)){
var managed_print_level_28070 = temp__5455__auto___28069;
var _STAR_print_level_STAR_28068_28071 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_28070;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_28068_28071,managed_print_level_28070,temp__5455__auto___28069,writer,opts,job_fn){
return (function (p1__28067_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__28067_SHARP_,null);
});})(_STAR_print_level_STAR_28068_28071,managed_print_level_28070,temp__5455__auto___28069,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_28068_28071;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1536537360506
