...
var G__28006 = devtools.prefs.pref.call(null,v);
v = G__28006;
continue;
} else {
return v;
...
}catch (e28009){var _e__27260__auto__ = e28009;
return false;
}})();
...
}catch (e28013){var _e__27260__auto__ = e28013;
return false;
}})();
...
}catch (e28015){var _e__27260__auto__ = e28015;
return false;
}}
}
});
...
var vec__28017 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__28017,(0),null);
var name = cljs.core.nth.call(null,vec__28017,(1),null);
...
return cljs.core.some.call(null,(function (p1__28020_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28020_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1536537360334
