...
}catch (e32071){var _e = e32071;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___32074 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___32074)){
var seen_errors_32075 = temp__5455__auto___32074;
if(cljs.core.truth_(seen_errors_32075.has(self))){
} else {
seen_errors_32075.add(self);

var temp__5457__auto___32076 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___32076)){
var sense_32077 = temp__5457__auto___32076;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_32077)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1536537367366
